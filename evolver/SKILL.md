...
metadata:
  ...
  shell_commands:
    ...
    - command: node
      ...
      user_input: false
    - command: npm
      purpose: "bun install --production for skill dependency healing"
      user_input: false
...
| `bun install --production` | Repair missing skill dependencies |
...
bun install -g @evomap/evolver@latest
```
